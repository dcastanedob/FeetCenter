    ...
    $.membresia = function(container, options){
        ...
        */
        ...
        plugin.init = function(){
            ...
            $container.find('input[name=membresia_vigencia],input[name=servicio_comision],input[name=membresia_servicios],input[name=membresia_cupones],input[name=membresia_precio]').numeric();
