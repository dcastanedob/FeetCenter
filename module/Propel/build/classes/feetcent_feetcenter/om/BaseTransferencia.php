...
abstract class BaseTransferencia extends BaseObject implements Persistent
{
     ...
     * el id del empleado que generó la transferenci
     * @return int
     */
     ...
     * empleado quien puso aceptado la transferencia
     * @return int
     */
     ...
     * clinica quien envía los productos o insumo
     * @return int
     */
     ...
     * fecha en que la clínica receptora, aceptó o rechazó la petic
     *
     * @param string $format The date/time format string (either date()-style or strftime()-style).
     *				 If format is null, then the raw DateTime object will be returned.
     ...
     * representa la ruta del comprobante pdf de la transferencia
     * @return string
     */
