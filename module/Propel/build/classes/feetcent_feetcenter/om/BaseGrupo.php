...
abstract class BaseGrupo extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the grupo_nombre field.
     * @var        string
     */
    protected $grupo_nombre;

    /**
     * The value for the grupo_descripcion field.
     * @var        string
     */
    protected $grupo_descripcion;

    /**
     * The value for the grupo_creadoen field.
     * @var        string
     */
    protected $grupo_creadoen;
    ...
    /**
     * Get the [grupo_nombre] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [grupo_descripcion] column value.
     *
     * @return string
     */
    public function getGrupoDescripcion()
    {
    ...
    /**
     * Get the [optionally formatted] temporal [grupo_creadoen] column value.
     * este lo setea el sistema
     *
     ...
     */
    public function getGrupoCreadoen($format = 'Y-m-d H:i:s')
    {
        if ($this->grupo_creadoen === null) {
            return null;
        }

        if ($this->grupo_creadoen === '0000-00-00 00:00:00') {
        ...
        try {
            $dt = new DateTime($this->grupo_creadoen);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->grupo_creadoen, true), $x);
        }
    ...
    /**
     * Set the value of [grupo_nombre] column.
     *
     * @param  string $v new value
     * @return Grupo The current object (for fluent API support)
     */
    public function setGrupoNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->grupo_nombre !== $v) {
            $this->grupo_nombre = $v;
            $this->modifiedColumns[] = GrupoPeer::GRUPO_NOMBRE;
        }
    ...
    /**
     * Set the value of [grupo_descripcion] column.
     *
     * @param  string $v new value
     * @return Grupo The current object (for fluent API support)
     */
    public function setGrupoDescripcion($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->grupo_descripcion !== $v) {
            $this->grupo_descripcion = $v;
            $this->modifiedColumns[] = GrupoPeer::GRUPO_DESCRIPCION;
        }
    ...
    /**
     * Sets the value of [grupo_creadoen] column to a normalized version of the date/time value specified.
     * este lo setea el sistema
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return Grupo The current object (for fluent API support)
     */
    public function setGrupoCreadoen($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->grupo_creadoen !== null || $dt !== null) {
            $currentDateAsString = ($this->grupo_creadoen !== null && $tmpDt = new DateTime($this->grupo_creadoen)) ? $tmpDt->format('Y-m-d H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->grupo_creadoen = $newDateAsString;
                $this->modifiedColumns[] = GrupoPeer::GRUPO_CREADOEN;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->grupo_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->grupo_descripcion = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->grupo_creadoen = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = GrupoPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GrupoPeer::IDGRUPO)) {
            $modifiedColumns[':p' . $index++]  = '`idgrupo`';
        }
        if ($this->isColumnModified(GrupoPeer::GRUPO_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`grupo_nombre`';
        }
        if ($this->isColumnModified(GrupoPeer::GRUPO_DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`grupo_descripcion`';
        }
        if ($this->isColumnModified(GrupoPeer::GRUPO_CREADOEN)) {
            $modifiedColumns[':p' . $index++]  = '`grupo_creadoen`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idgrupo`':
                        ...
                        break;
                    case '`grupo_nombre`':
                        $stmt->bindValue($identifier, $this->grupo_nombre, PDO::PARAM_STR);
                        break;
                    case '`grupo_descripcion`':
                        $stmt->bindValue($identifier, $this->grupo_descripcion, PDO::PARAM_STR);
                        break;
                    case '`grupo_creadoen`':
                        $stmt->bindValue($identifier, $this->grupo_creadoen, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getGrupoNombre();
                break;
            case 2:
                return $this->getGrupoDescripcion();
                break;
            case 3:
                return $this->getGrupoCreadoen();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getGrupoNombre(),
            $keys[2] => $this->getGrupoDescripcion(),
            $keys[3] => $this->getGrupoCreadoen(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setGrupoNombre($value);
                break;
            case 2:
                $this->setGrupoDescripcion($value);
                break;
            case 3:
                $this->setGrupoCreadoen($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setGrupoNombre($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setGrupoDescripcion($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setGrupoCreadoen($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GrupoPeer::GRUPO_NOMBRE)) $criteria->add(GrupoPeer::GRUPO_NOMBRE, $this->grupo_nombre);
        if ($this->isColumnModified(GrupoPeer::GRUPO_DESCRIPCION)) $criteria->add(GrupoPeer::GRUPO_DESCRIPCION, $this->grupo_descripcion);
        if ($this->isColumnModified(GrupoPeer::GRUPO_CREADOEN)) $criteria->add(GrupoPeer::GRUPO_CREADOEN, $this->grupo_creadoen);
    ...
    {
        $copyObj->setGrupoNombre($this->getGrupoNombre());
        $copyObj->setGrupoDescripcion($this->getGrupoDescripcion());
        $copyObj->setGrupoCreadoen($this->getGrupoCreadoen());
    ...
    public function setGrupopacientes(PropelCollection $grupopacientes, PropelPDO $con = null)
    {
        ...
        foreach ($grupopacientesToDelete as $grupopacienteRemoved) {
            $grupopacienteRemoved->setGrupo(null);
        }
     ...
     * @return PropelObjectCollection|Grupopaciente[] List of Grupopaciente objects
     */
    public function getGrupopacientesJoinPaciente($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = GrupopacienteQuery::create(null, $criteria);
    ...
    public function clear()
    {
        ...
        $this->grupo_descripcion = null;
        $this->grupo_creadoen = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
