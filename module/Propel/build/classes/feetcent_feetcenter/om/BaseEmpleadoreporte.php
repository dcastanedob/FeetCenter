...
/**
 * Base class that represents a row from the 'empleadoreporte' table.
 *
 *
 *
 * @package    propel.generator.feetcent_feetcenter.om
 */
abstract class BaseEmpleadoreporte extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'EmpleadoreportePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EmpleadoreportePeer
     */
    ...
    /**
     * The value for the idempleadoreporte field.
     * @var        int
     */
    protected $idempleadoreporte;
    ...
    /**
     * The value for the idempleadoreportado field.
     * @var        int
     */
     ...
     * @var        string
     */
    protected $empleadoreporte_comentario;

    /**
     * The value for the empleadoreporte_fechasuceso field.
     * @var        string
     */
    ...
    /**
     * @var        Conceptoincidencia
     */
    protected $aConceptoincidencia;
    ...
    /**
     * Get the [idempleadoreporte] column value.
     *
     * @return int
     */
    public function getIdempleadoreporte()
    {

        return $this->idempleadoreporte;
    }
    ...
    /**
     * Get the [idempleadoreportado] column value.
     *
     * @return int
     */
    public function getIdempleadoreportado()
    {

        return $this->idempleadoreportado;
    }
     ...
     * la definimos nosotros al momento de hacer el insert
     *
     ...
     * @return string
     */
    public function getEmpleadoreporteComentario()
    {

        return $this->empleadoreporte_comentario;
    }

    /**
     * Get the [optionally formatted] temporal [empleadoreporte_fechasuceso] column value.
     *
     *
     * @param string $format The date/time format string (either date()-style or strftime()-style).
     *				 If format is null, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getEmpleadoreporteFechasuceso($format = '%x')
    {
        if ($this->empleadoreporte_fechasuceso === null) {
            return null;
        }

        if ($this->empleadoreporte_fechasuceso === '0000-00-00') {
            // while technically this is not a default value of null,
            // this seems to be closest in meaning.
            return null;
        }
    ...
    /**
     * Set the value of [idempleadoreporte] column.
     *
     * @param  int $v new value
     * @return Empleadoreporte The current object (for fluent API support)
     */
    public function setIdempleadoreporte($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idempleadoreporte !== $v) {
            $this->idempleadoreporte = $v;
            $this->modifiedColumns[] = EmpleadoreportePeer::IDEMPLEADOREPORTE;
        }


        return $this;
    } // setIdempleadoreporte()
    ...
    /**
     * Set the value of [idempleadoreportado] column.
     *
     * @param  int $v new value
     * @return Empleadoreporte The current object (for fluent API support)
     */
    public function setIdempleadoreportado($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idempleadoreportado !== $v) {
            $this->idempleadoreportado = $v;
    ...
    public function setIdconceptoincidencia($v)
    {
        ...
        if ($this->idconceptoincidencia !== $v) {
            ...
            $this->modifiedColumns[] = EmpleadoreportePeer::IDCONCEPTOINCIDENCIA;
        }

        if ($this->aConceptoincidencia !== null && $this->aConceptoincidencia->getIdconceptoincidencia() !== $v) {
            $this->aConceptoincidencia = null;
        }
     ...
     * @return Empleadoreporte The current object (for fluent API support)
     */
    public function setEmpleadoreporteComentario($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->empleadoreporte_comentario !== $v) {
            $this->empleadoreporte_comentario = $v;
            $this->modifiedColumns[] = EmpleadoreportePeer::EMPLEADOREPORTE_COMENTARIO;
        }


        return $this;
    } // setEmpleadoreporteComentario()

    /**
     * Sets the value of [empleadoreporte_fechasuceso] column to a normalized version of the date/time value specified.
     *
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return Empleadoreporte The current object (for fluent API support)
     */
    public function setEmpleadoreporteFechasuceso($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->empleadoreporte_fechasuceso !== null || $dt !== null) {
            $currentDateAsString = ($this->empleadoreporte_fechasuceso !== null && $tmpDt = new DateTime($this->empleadoreporte_fechasuceso)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->empleadoreporte_fechasuceso = $newDateAsString;
                $this->modifiedColumns[] = EmpleadoreportePeer::EMPLEADOREPORTE_FECHASUCESO;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idempleadoreporte = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            $this->idconceptoincidencia = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->empleadoreporte_fechacreacion = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->empleadoreporte_comentario = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->empleadoreporte_fechasuceso = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = EmpleadoreportePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Empleadoreporte object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aConceptoincidencia !== null && $this->idconceptoincidencia !== $this->aConceptoincidencia->getIdconceptoincidencia()) {
            $this->aConceptoincidencia = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EmpleadoreportePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getConnection(EmpleadoreportePeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }

        $con->beginTransaction();
        try {
            $deleteQuery = EmpleadoreporteQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EmpleadoreportePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aConceptoincidencia !== null) {
                if ($this->aConceptoincidencia->isModified() || $this->aConceptoincidencia->isNew()) {
                    $affectedRows += $this->aConceptoincidencia->save($con);
                }
                $this->setConceptoincidencia($this->aConceptoincidencia);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = EmpleadoreportePeer::IDEMPLEADOREPORTE;
        if (null !== $this->idempleadoreporte) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . EmpleadoreportePeer::IDEMPLEADOREPORTE . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(EmpleadoreportePeer::IDEMPLEADOREPORTE)) {
            $modifiedColumns[':p' . $index++]  = '`idempleadoreporte`';
        }
        if ($this->isColumnModified(EmpleadoreportePeer::IDCLINICA)) {
            $modifiedColumns[':p' . $index++]  = '`idclinica`';
        }
        if ($this->isColumnModified(EmpleadoreportePeer::IDEMPLEADO)) {
        ...
        if ($this->isColumnModified(EmpleadoreportePeer::IDCONCEPTOINCIDENCIA)) {
        ...
        $sql = sprintf(
            'INSERT INTO `empleadoreporte` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idempleadoreporte`':
                        $stmt->bindValue($identifier, $this->idempleadoreporte, PDO::PARAM_INT);
                        break;
                    case '`idclinica`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aConceptoincidencia !== null) {
                if (!$this->aConceptoincidencia->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aConceptoincidencia->getValidationFailures());
                }
            }
    ...
    {
        $pos = EmpleadoreportePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdempleadoreporte();
                break;
            case 1:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Empleadoreporte'][$this->getPrimaryKey()] = true;
        $keys = EmpleadoreportePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdempleadoreporte(),
            $keys[1] => $this->getIdclinica(),
            $keys[2] => $this->getIdempleado(),
            $keys[3] => $this->getIdempleadoreportado(),
            $keys[4] => $this->getIdconceptoincidencia(),
            $keys[5] => $this->getEmpleadoreporteFechacreacion(),
            $keys[6] => $this->getEmpleadoreporteComentario(),
            $keys[7] => $this->getEmpleadoreporteFechasuceso(),
        );
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aConceptoincidencia) {
                $result['Conceptoincidencia'] = $this->aConceptoincidencia->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdempleadoreporte($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdempleadoreporte($arr[$keys[0]]);
        ...
        if (array_key_exists($keys[4], $arr)) $this->setIdconceptoincidencia($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setEmpleadoreporteFechacreacion($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setEmpleadoreporteComentario($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setEmpleadoreporteFechasuceso($arr[$keys[7]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EmpleadoreportePeer::IDEMPLEADOREPORTE)) $criteria->add(EmpleadoreportePeer::IDEMPLEADOREPORTE, $this->idempleadoreporte);
        ...
        if ($this->isColumnModified(EmpleadoreportePeer::IDCONCEPTOINCIDENCIA)) $criteria->add(EmpleadoreportePeer::IDCONCEPTOINCIDENCIA, $this->idconceptoincidencia);
    ...
    {
        $criteria = new Criteria(EmpleadoreportePeer::DATABASE_NAME);
        $criteria->add(EmpleadoreportePeer::IDEMPLEADOREPORTE, $this->idempleadoreporte);
    ...
    /**
     * Generic method to set the primary key (idempleadoreporte column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdempleadoreporte();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Empleadoreporte (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIdconceptoincidencia($this->getIdconceptoincidencia());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Empleadoreporte Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EmpleadoreportePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EmpleadoreportePeer();
        }
    ...
    /**
     * Declares an association between this object and a Conceptoincidencia object.
     *
     * @param                  Conceptoincidencia $v
     * @return Empleadoreporte The current object (for fluent API support)
     * @throws PropelException
     */
    public function setConceptoincidencia(Conceptoincidencia $v = null)
    {
        if ($v === null) {
            $this->setIdconceptoincidencia(NULL);
        } else {
            $this->setIdconceptoincidencia($v->getIdconceptoincidencia());
        }

        $this->aConceptoincidencia = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Conceptoincidencia object, it will not be re-added.
        if ($v !== null) {
            $v->addEmpleadoreporte($this);
        }
    ...
    /**
     * Get the associated Conceptoincidencia object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Conceptoincidencia The associated Conceptoincidencia object.
     * @throws PropelException
     */
    public function getConceptoincidencia(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aConceptoincidencia === null && ($this->idconceptoincidencia !== null) && $doQuery) {
            $this->aConceptoincidencia = ConceptoincidenciaQuery::create()->findPk($this->idconceptoincidencia, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aConceptoincidencia->addEmpleadoreportes($this);
             */
        }

        return $this->aConceptoincidencia;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aConceptoincidencia instanceof Persistent) {
              $this->aConceptoincidencia->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(EmpleadoreportePeer::DEFAULT_STRING_FORMAT);
    }
