...
class PacientesController extends AbstractActionController
{
    ...
    public function editarAction(){
        ...
        if ($request->isPost()) { //Si hicieron POST
            ...
            $pacientelog = new \Pacientelog();
            $pacientelog->setIdpaciente($entity->getIdpaciente())
                        ->setIdempleado($sesion->getIdempleado())
                        ->setPacientelogFecha(new \DateTime())
                        ->setpacientelogNombreOld($entity->getPacienteNombre())
                        ->setPacientelogTelefonoOld($entity->getPacienteCelular());
            ...
            if(isset($post_data['paciente_fechanacimiento_submit']) && $post_data['paciente_fechanacimiento_submit'] != ""){
                $entity->setPacienteFechanacimiento('paciente_fechanacimiento_submit');
            }


            $pacientelog->setpacientelogNombreNew($entity->getPacienteNombre())
                        ->setPacientelogTelefonoNew($entity->getPacienteCelular())
                        ->save();
        ...
        //HISTORIAL
        $history = \PacientelogQuery::create()->filterByIdpaciente($entity->getIdpaciente())->orderByPacientelogFecha(\Criteria::DESC)->find();
